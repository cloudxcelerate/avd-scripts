...
$osOptURLexe = 'Windows_10_11_VDI_Optimize-main.zip'
...
Expand-Archive -LiteralPath 'C:\\Optimize\\Windows_10_11_VDI_Optimize-main.zip' -DestinationPath $Localpath -Force -Verbose
Set-ExecutionPolicy -ExecutionPolicy RemoteSigned -Scope Process
Set-Location -Path C:\\Optimize\\Virtual-Desktop-Optimization-Tool-main

# Patch: override the Win10_VirtualDesktop_Optimize.ps1 - setting 'Set-NetAdapterAdvancedProperty'
